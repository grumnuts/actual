...
- **Repository**: https://github.com/grumnuts/actual
- **Community Docs**: Documentation is part of the monorepo at `packages/docs/`.
- **License**: MIT
...
- **GitHub Issues**: https://github.com/grumnuts/actual/issues
