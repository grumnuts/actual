...
const CATALOG_URL = `https://raw.githubusercontent.com/grumnuts/actual/${process.env.REACT_APP_BRANCH || 'master'}/packages/desktop-client/src/data/customThemeCatalog.json`;
