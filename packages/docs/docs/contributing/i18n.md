...
Actual uses [Weblate](https://hosted.weblate.org/projects/grumnuts/actual) to manage all translations. In particular, we use Weblate's "suggestions" system to maintain high-quality translations.
