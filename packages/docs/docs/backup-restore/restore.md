...
1. You should see a list of integers under the' id' column. Cross-reference the entries in this table with the list of [database migrations](https://github.com/grumnuts/actual/tree/master/packages/loot-core/migrations) in the main Actual repository.
